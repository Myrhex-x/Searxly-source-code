...
@objc protocol SearxlyHelperProtocol {
    ...
    /// transport line is empty. The app builds these from the bundled transport paths — see
    /// TorBridgeSettings — so the helper only assembles known torrc directives.
